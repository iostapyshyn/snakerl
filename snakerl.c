...
int game_update(enum direction dir) {
    /* The position if the head after the movement. */
...
int main(int argc, char *argv[]) {
    char *font = argc > 1 ? argv[1] : "fonts/terminus_11x11.bmp";

    if (!ui_init("./snakerl", font, UI_COLS, UI_ROWS))
        return 1;
